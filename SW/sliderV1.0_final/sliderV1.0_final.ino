...
#define EE_ADDR_LIVEMOTION_SPEED         18   // 2byte
#define EE_ADDR_INTERNAL_MOTOR_STEPS     20   // 2byte     

#define UNIT_LIVEMOTION_SPEED            "*0.5 mm/s"
...
unsigned int settings_livemotion_speed;
...
void on_livemotion_start(MenuItem* p_menu_item);
...
// Live motion
const Menu mu_livemotion("LIVE MOTION");
const MenuItem mi_livemotion_start("Start", &on_livemotion_start);
const MenuItem mi_livemotion_speed("Speed", &on_livemotion_speed);  //dorobit!!!!!!!
const MenuItem mi_livemotion_exit("Exit", &on_exit);
...
const MenuItem mi_timelapse_hard_duty("Hard_duty", &on_timelapse_hard_duty);
...
int read_livemotion_automation();
